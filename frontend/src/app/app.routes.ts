...
export const routes: Routes = [
  ...
  { path: 'category/:id', loadComponent: () => import('./pages/product-list/product-list').then(m => m.ProductListComponent) },
  { path: 'category/:id/:subid', loadComponent: () => import('./pages/product-list/product-list').then(m => m.ProductListComponent) },
  ...
  { path: 'register', loadComponent: () => import('./pages/auth/register/register').then(m => m.RegisterPage) },
  { path: 'account', canActivate: [authGuard], loadComponent: () => import('./pages/account/account').then(m => m.AccountPage) },
  { path: 'admin', canActivate: [authGuard, adminGuard], loadComponent: () => import('./pages/admin/admin').then(m => m.AdminPage) },
  { path: 'admin/products', canActivate: [authGuard, adminGuard], loadComponent: () => import('./pages/admin/products/admin-products').then(m => m.AdminProductsPage) },
  { path: 'admin/orders', canActivate: [authGuard, adminGuard], loadComponent: () => import('./pages/admin/orders/admin-orders').then(m => m.AdminOrdersPage) },
  { path: 'admin/users', canActivate: [authGuard, adminGuard], loadComponent: () => import('./pages/admin/users/admin-users').then(m => m.AdminUsersPage) },
  { path: 'admin/coupons', canActivate: [authGuard, adminGuard], loadComponent: () => import('./pages/admin/coupons/admin-coupons').then(m => m.AdminCouponsPage) },
